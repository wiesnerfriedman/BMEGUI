 ...
 */
FARPROC WINAPI csvFileWriterDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = csvFileWriterDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = csvFileWriterDelayLoadWin32FailureHook;
#endif
