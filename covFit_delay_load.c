 ...
 */
FARPROC WINAPI covFitDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = covFitDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = covFitDelayLoadWin32FailureHook;
#endif
