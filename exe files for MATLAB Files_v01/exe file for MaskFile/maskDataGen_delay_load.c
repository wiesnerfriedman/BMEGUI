 ...
 */
FARPROC WINAPI maskDataGenDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = maskDataGenDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = maskDataGenDelayLoadWin32FailureHook;
#endif
