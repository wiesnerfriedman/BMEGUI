 ...
 */
FARPROC WINAPI bmeEstDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = bmeEstDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = bmeEstDelayLoadWin32FailureHook;
#endif
