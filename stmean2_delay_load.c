 ...
 */
FARPROC WINAPI stmean2DelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = stmean2DelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = stmean2DelayLoadWin32FailureHook;
#endif
