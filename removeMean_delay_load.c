 ...
 */
FARPROC WINAPI removeMeanDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = removeMeanDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = removeMeanDelayLoadWin32FailureHook;
#endif
