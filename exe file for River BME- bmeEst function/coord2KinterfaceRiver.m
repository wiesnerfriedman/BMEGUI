function [K]=coord2KinterfaceRiver(c1,c2,model,param,dist);
...
% SYNTAX :
%
% [K]=coord2Kinterface(c1,c2,model,param,dist);
%
% INPUT :
%  same as coord2K
%
...
if n1==0 | n2==0,               %%%Return K=zeros(n1,n2) if n1==0 or n2==0
   K=zeros(n1,n2);
else                            %%%Else call coord2K
  K=coord2K(c1,c2,model,param,dist);
end;
