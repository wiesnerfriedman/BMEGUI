function [csub,nlsub,limisub,probdenssub,dsub,nsub,index]=...
  probaneighboursRiver(c0,c,softpdftype,nl,limi,probdens,nmax,dmax,dist);
...
%   probaneighbours(c0,c,nl,limi,probdens,nmax,dmax,dist);
%
% INPUT :
%
...
if nargin<9, dist{1}={'coord2dist'}; end;

[csub,probasub,dsub,nsub,index]=neighbours(c0,c,[nl limi probdens],nmax,dmax,dist);
