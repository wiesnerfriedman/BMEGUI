 ...
 */
FARPROC WINAPI checkRiverNetworkContinuityTestsDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = checkRiverNetworkContinuityTestsDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = checkRiverNetworkContinuityTestsDelayLoadWin32FailureHook;
#endif
