 ...
 */
FARPROC WINAPI mapDataGenDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = mapDataGenDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = mapDataGenDelayLoadWin32FailureHook;
#endif
