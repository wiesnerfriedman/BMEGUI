 ...
 */
FARPROC WINAPI calcMeanDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = calcMeanDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = calcMeanDelayLoadWin32FailureHook;
#endif
