 ...
 */
FARPROC WINAPI errorDialDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = errorDialDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = errorDialDelayLoadWin32FailureHook;
#endif
