 ...
 */
FARPROC WINAPI bmeEstStatDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = bmeEstStatDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = bmeEstStatDelayLoadWin32FailureHook;
#endif
