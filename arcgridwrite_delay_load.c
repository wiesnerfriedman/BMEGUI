 ...
 */
FARPROC WINAPI arcgridwriteDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = arcgridwriteDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = arcgridwriteDelayLoadWin32FailureHook;
#endif
