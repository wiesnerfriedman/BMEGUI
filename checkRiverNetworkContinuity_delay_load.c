 ...
 */
FARPROC WINAPI checkRiverNetworkContinuityDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = checkRiverNetworkContinuityDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = checkRiverNetworkContinuityDelayLoadWin32FailureHook;
#endif
