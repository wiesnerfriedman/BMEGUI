 ...
 */
FARPROC WINAPI removeDupliDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = removeDupliDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = removeDupliDelayLoadWin32FailureHook;
#endif
