 ...
 */
FARPROC WINAPI calcGridDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = calcGridDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = calcGridDelayLoadWin32FailureHook;
#endif
