function [Val,Err,Info]=mvMomVec(softpdftype,nl,limi,probdens,Mean,C,nMom,As,Bs,P,maxpts,aEps,rEps); 

% mvMomVec                  - Multi-Variate integrals arising from calculation of Moments (Jan 1, 2001)
%
...
% As, bs and p coefficients defined in As, Bs and P. 
%
...
% SYNTAX :
%
% [Val,Err,Info]=mvMomVec(softpdftype,nl,limi,probdens,Mean,C,...
%   nMom,As,bs,p,maxpts,aEps,rEps,mvMom);
%
% INPUT :
%
...
if length(nl)==1
  ...
  [Val Err Info]=mvMomVecAG2(softpdftype,nl,limi,probdens,Mean,C,nMom,As,Bs,P,maxpts,aEps,rEps);   
end  