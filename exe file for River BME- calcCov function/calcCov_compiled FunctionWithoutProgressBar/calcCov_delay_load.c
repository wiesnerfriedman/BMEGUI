 ...
 */
FARPROC WINAPI calcCovDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = calcCovDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = calcCovDelayLoadWin32FailureHook;
#endif
