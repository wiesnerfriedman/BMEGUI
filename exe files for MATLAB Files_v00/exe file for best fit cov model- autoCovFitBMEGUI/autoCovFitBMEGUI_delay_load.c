 ...
 */
FARPROC WINAPI autoCovFitBMEGUIDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = autoCovFitBMEGUIDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = autoCovFitBMEGUIDelayLoadWin32FailureHook;
#endif
