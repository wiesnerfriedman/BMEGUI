% BMELIB analysis of space/time variability, variogram and covariance models (Jan 1, 2001)
%
%   exponentialC              - exponential covariance model 
%   exponentialV              - exponential variogram model 
%   gaussianC                 - Gaussian covariance model 
%   gaussianCST               - Gaussian non separable S/T covariance model (Jan 1, 2001)
%   gaussianV                 - Gaussian variogram model 
%   holecosC                  - cosinusoidal hole effect covariance model 
%   holecosV                  - cosinusoidal hole effect variogram model 
%   holesinC                  - sinusoidal hole effect covariance model 
%   holesinV                  - sinusoidal hole effect variogram model 
%   linearV                   - linear variogram model 
%   model2indic               - indicator covariance model from Gaussian distribution 
%   modelplot                 - plot variogram or covariance models 
%   nparammodels              - name and # of parameters for covariance models (Jan 1, 2001)
%   nuggetC                   - nugget effect covariance model 
%   nuggetV                   - nugget effect variogram model 
%   powerV                    - power variogram model 
%   sphericalC                - spherical covariance model 
%   sphericalV                - spherical variogram model 
