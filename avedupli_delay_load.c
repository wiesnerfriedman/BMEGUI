 ...
 */
FARPROC WINAPI avedupliDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = avedupliDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = avedupliDelayLoadWin32FailureHook;
#endif
